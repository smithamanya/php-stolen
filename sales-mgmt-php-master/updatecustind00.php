...
<div class="headerplace">You are here >> Issue Item >> <a href="issueitem.php">Opening Entry</a></div>
...
<td>Customer e-mail Address</td><td><label><input type="text" name="custemail" value="<?php echo $data->custemail;?>"/></label></td></tr>
